...
require('chai').should();
var deparam = require('../index.js').deparam;

describe('node-qs-serialization.deparam', function() {
  it('loads', function() {
    deparam.should.be.a('function');
  });
  ...
  describe('bbq specs', function() {
    it('deserializes 1.4-style params', function() {
      var paramStr = 'a[]=4&a[]=5&a[]=6&b[x][]=7&b[y]=8&b[z][]=9&b[z][]=0' +
    ...
    it('deserializes pre-1.4-style params without coercion', function() {
      var paramStr = 'a=1&a=2&a=3&b=4&c=5&c=6&c=true&c=false' +
        '&c=undefined&c=&d=7';
      var paramsObj = {
        a: ['1', '2', '3' ],
        b: '4',
  ...
  describe('Should work correctly with encoded characters', function() {
    ...
    it('deserializes and decodes accented characters UTF-8 ', function() {
      deparam('par=t%C3%A9l%C3%A9%20club%20').par.should
        .equal('t\xe9l\xe9 club ');
    });
    it('deserializes and decodes spaces both encoded as %20 as well as +', function() {
      deparam('par=1+2%203+4%205').par.should
        .equal('1 2 3 4 5');
    });
  });
