...
function decoded(o) { return decodeURIComponent(param(o)); }
...
eq(param({ a: function() { return 'computed'; } }), 'a=computed', 'function value');
...
var bbqStr = 'a[]=4&a[]=5&a[]=6&b[x][]=7&b[y]=8&b[z][]=9&b[z][]=0' +
